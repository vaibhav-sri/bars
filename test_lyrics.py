...
class TestLyricsDaemon(unittest.TestCase):
    ...
    @patch('lyrics.get_mpris_players')
    @patch('lyrics.get_metadata')
    @patch('lyrics.get_cached_lyrics')
    ...
    def test_get_cached_lyrics_corrupted_cache(
        ...
        lrc = lyrics.get_cached_lyrics("Artist", "Title")
